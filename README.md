...
<!-- Generated by `npm run test:e2e:screenshot` — see CONTRIBUTING.md -->
![Projects View dashboard](docs/screenshots/home.png)
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for testing, e2e setup, and updating the README screenshot.
